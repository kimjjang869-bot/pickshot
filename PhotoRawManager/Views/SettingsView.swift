...
struct SettingsView: View {
    var body: some View {
        TabView {
            ...
            AIEngineSettingsTab()
                .tabItem {
                    Label("AI 엔진", systemImage: "cpu")
                }

            PerformanceSettingsTab()
                .tabItem {
                    Label("퍼포먼스", systemImage: "speedometer")
                }
                ...
                GroupBox("해상도 및 캐시") {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Slider(value: $previewCacheSize, in: 10...50, step: 1)
                        }
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Slider(value: $defaultThumbnailSize, in: 80...300, step: 10)
                        }
                    }
                    .padding(4)
                }
